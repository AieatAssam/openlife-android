...
| C0-R26 (provider-independent byte ceiling) | `ImportRepositoryTest.excessBytesAreRejectedAndLeaveNoStagedState` | Streams limit+1 synthetic bytes through the real repository and asserts row/artefact cleanup; passes in the 57/57 connected vault run |
